...
- Step 2: Use LASSO regression to select variables in the training set
- Step 3: Use LR to construct a predictive model on 4-fold data and validate it on the remaining 1-fold
- Step 4: Use RF to construct a predictive model on 4-fold data and validate it on the remaining 1-fold
...
绘制ROC，对比LR和RF。
Draw ROC and compare LR and RF.
