...
library(msa)       # 用于多序列比对的包 # For multiple sequence alignment
library(seqinr)    # 提供序列处理和分析功能的包 # Provides sequence processing and analysis functions
library(ape)       # 用于进化分析的包 # For evolutionary analysis
library(ggtree)    # 用于可视化进化树的包 # For visualizing phylogenetic trees
# 设置系统环境，使R显示英文错误信息
