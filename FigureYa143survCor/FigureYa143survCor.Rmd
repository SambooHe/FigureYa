...
下载MSI信息：
Download MSI information:

下载过程完成后存储为当前文件夹下的msi_results.rda文件，便于重复使用。
After the download process is completed, it is stored as the msi_results.rda file in the current folder for easy reuse.
...
Select expression matrix, survival information, and common samples containing clear MSI information:
