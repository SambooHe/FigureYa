...
I want to modify the pan-cancer enrichment analysis in FigureYa253panGSEA from "single-gene multi-pathway" to "multi-gene single-pathway" analysis. That is, changing the Y-axis in the figure to show genes while keeping the X-axis as cancer types.
