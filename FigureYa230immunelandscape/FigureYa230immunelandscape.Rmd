...
- To calculate the CIBERSORT score and ESTIMATE score, see FigureYa211multiCohortImmSubtype
- ssGSEA, see FigureYa71ssGSEA
- TIMER, for downloading TIMER data from the website, please refer to FigureYa234panImmune, and for TIMER scoring with the immunedeconv package, please refer to FigureYa264epiImmune
