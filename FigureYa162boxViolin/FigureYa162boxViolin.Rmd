...
easy_input.csv, the first column is the continuous variable, the second column is the grouping.
...
Use ggpubr's stat_compare_means to perform the kruskal.test
