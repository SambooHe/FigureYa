...
> Note: Using the same method to obtain mutation data for FigureYa276panSNV target genes, saved as frequently-mutated-genes.2022-06-03.tsv. Compared with the first plot in FigureYa276panSNV (starting from Xena database download), the trends are generally consistent.
