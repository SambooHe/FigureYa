...
From<https://dx.doi.org/10.3390/ijms21051686>

Figure 5. Relationship between mRNA and protein expression in TW/NW (A) and TW/OW (B).

![](example2.png)

From<https://www.nature.com/articles/nature21036>
...
From<https://science.sciencemag.org/content/362/6413/eaav1898>
...
library(ggrepel) # 避免标签重叠 | Avoid overlapping labels
library(cowplot) # 拼图 | Plot composition
