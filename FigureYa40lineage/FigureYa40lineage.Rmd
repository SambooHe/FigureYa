---
title: "FigureYa40lineages_analysis"
params:
  author: "Zhougeng Xu"
  reviewer: "Ying Ge, Taojun Ye"
output: 
  html_document:
    toc: true
    toc_depth: 3
...
library(monocle) # 单细胞谱系分析 single-cell lineage analysis
...
exprs_file <- 'easy_input_TPM.txt.zip'  # 表达矩阵文件路径 | Path to expression matrix file
...
According to [GSE98638](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE98638) on GEO. Download raw count data.
...
## 细胞谱系分析 Cell lineage analysis

### 第一步:定义排序基因 Step 1: Define sorting genes
...
### 第二步: 降维 Step 2: Dimensionality Reduction
...
### 第三步: 在谱系上对细胞排序 Step 3: Sort the cells on the lineage
