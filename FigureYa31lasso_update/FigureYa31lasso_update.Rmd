...
Figure 1: Construction of the six-miRNA-based classifier
(B) LASSO coefficient profiles of the 35 colon-cancer-associated miRNAs. A vertical line is drawn at the value chosen by 10-fold cross-validation.
...
### 算出lambda值 Calculate the lambda value
...
### 修改画图函数 Modify the plotting function
...
### 在线的旁边显示基因名 Display the gene name next to the line
...
### 以图例的形式展示基因名 Show gene names in legend form
...
## 输出用于nomogram作图的文件 Output files for nomogram graphing
