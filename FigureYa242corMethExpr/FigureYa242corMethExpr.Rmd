...
Correlation between FPKM and promoter methylation. Input data is TCGA FPKM and DNA methylation data.

Hope to learn how to obtain methylation probes in gene promoter regions, and be able to flexibly customize promoter regions like TSS1500, TSS200, and even analyze the relationship between gene body methylation and gene expression.

From<https://academic.oup.com/nar/article/48/D1/D856/5584613>

## 应用场景 / Application Scenario
计算特定基因启动子DNA甲基化与对应表达谱的相关性并绘图。

Calculate and plot the correlation between specific gene promoter DNA methylation and corresponding expression profiles.
...
TCGA-UCEC.methylation450.tsv.gz，UCEC的DNA甲基化数据，下载自XENA<https://xenabrowser.net/datapages/?dataset=TCGA-UCEC.methylation450.tsv&host=https%3A%2F%2Fgdc.xenahubs.net&removeHub=https%3A%2F%2Fxena.treehouse.gi.ucsc.edu%3A443>(需科学上网)
