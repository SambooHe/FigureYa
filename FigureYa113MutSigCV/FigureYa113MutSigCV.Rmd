...
以上默认文件的源文件下载自<https://software.broadinstitute.org/cancer/cga/mutsig_download>，注册后就能下载。下载后全部解压到当前文件夹。
...
The source files for the default files above were downloaded from< https://software.broadinstitute.org/cancer/cga/mutsig_download >After registration, you can download it. After downloading, unzip everything to the current folder.
...
The 30 day trial version of Matlab R2019a has been successfully run.
