...
对应文章中的Figure 3E
Corresponds to Figure 3E in the article
...
I'll repeat the steps for Figs. 5B and 5C here; the rest are similar.

GSE6764数据集：10 nontumor liver samples, 17 dysplastic liver samples, 13 cirrhotic liver samples, and 35 HCC samples
GSE6764 dataset: 10 nontumor liver samples, 17 dysplastic liver samples, 13 cirrhotic liver samples, and 35 HCC samples
...
Prepare the dataset: expression matrix and clinical group data, following standard GEO dataset usage, in Prepare_GEO.R.
