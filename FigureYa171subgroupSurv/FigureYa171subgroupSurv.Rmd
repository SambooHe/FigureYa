...
Essentially, this involves filtering data by condition each time and then performing a survival analysis. The key is in filtering the data.

## 自定义函数
## Custom function

给一个筛选标准，直接画图。
Give a filtering criterion and plot directly.
...
## print = T，直接显示
## arrange_ggsurvplots comes from the survminer package and is used to arrange the results.
## print = T, direct display
arrange_ggsurvplots(p, print = T,
                    ncol = 4, nrow = 2,
                    labels=LETTERS[1:8])

## 或者print = F, 然后保存到PDF文件
## Or print = F, then save to PDF file
