...
Use R to implement the algorithm for calculating diversity score in the article.

![](method.png)

出自<https://www.sciencedirect.com/science/article/pii/S1535610819303757>
From <https://www.sciencedirect.com/science/article/pii/S1535610819303757>

顺便画出下图：
By the way, draw the following figure:
...
Use single-cell DNA sequencing data to calculate the diversity score to evaluate tumor heterogeneity.
...
According to the method described in the article, customize the function to calculate the diversity score
...
Download and mine the single-cell sequencing data published on GEO in this way:

1) 打开页面<https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE125449>，拖到底，在Supplementary file里，点击ftp，下载下面四个文件：
1) Open the page <https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE125449>, scroll to the bottom, click ftp in Supplementary file, and download the following four files:
...
**!!! Important !!!**Put these four files in the `./data/` folder

2) 解压缩，按以下规则重命名:   
2) Unzip and rename as follows:
