...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 1em 2em; background: #fff; border-bottom: 1px solid #ddd;">
  <div style="display: flex; align-items: center; gap: 12px;">
    <img src="logo.svg" alt="FigureYa Logo" style="height: 32px; width: auto;">
    <span style="font-size: 1.25em; font-weight: 600; color: #1a202c;">FigureYa</span>
  </div>
  <div style="display: flex; gap: 20px;">
    <a href="#citation" style="color: #3182ce; text-decoration: none; font-weight: 500;">Citation</a>
    <a href="https://zread.ai/ying-ge/FigureYa" target="_blank" style="color: #3182ce; text-decoration: none; font-weight: 500;">FigureYa AI Assistant</a>
    <a href="https://github.com/ying-ge/FigureYa/stargazers" target="_blank" style="color: #3182ce; text-decoration: none; font-weight: 500;">Stats</a>
    <a href="#contact" style="color: #3182ce; text-decoration: none; font-weight: 500;">Contact</a>
  </div>
</div>
...
<div style="font-family: sans-serif; max-width: 800px; margin: 2em auto; padding: 1em; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 1em 0; border-radius: 4px;">
        <p style="margin: 0;"><strong>Note:</strong> This repository (<strong>FigureYa</strong>) contains analyses and visualizations that primarily use <strong>R</strong>. For analyses that require <strong>Python</strong> (Jupyter notebooks), please visit: <a href="https://ying-ge.github.io/FigureYapy" target="_blank" style="color: #1976d2; font-weight: bold;">https://ying-ge.github.io/FigureYapy</a></p>
    </div>
...
<p>WeChat ID: <strong>epigenomics</strong></p>
</div>
<hr>
