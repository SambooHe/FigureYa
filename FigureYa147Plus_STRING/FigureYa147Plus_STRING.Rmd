...
STRING数据库<https://string-db.org>，点击STRING chat。

输入：“show me a table of proteins interact with FoxP3 in human, with score > 0.8, including four columns: FoxP3, the other protein, location, score”
