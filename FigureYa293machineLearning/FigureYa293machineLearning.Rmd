...
TCGA.txt, GSE57303.txt, GSE62254.txt, datasets. Rows represent samples, with the first column being sample names, the second and third columns being survival time and survival status, and the remaining columns all being genes.
...
# 2. 变量选择：基于变量重要性（vimp）
# 2. Feature selection: based on variable importance (vimp)
...
For A_lasso.pdf, gene names can be labeled on the plot. Refer to FigureYa31lasso for method: 
