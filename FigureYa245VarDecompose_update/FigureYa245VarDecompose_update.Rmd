---
title: "FigureYa245VarDecompose_update"
params:
  author: "Jianing Gao"
...
mart_export.txt，人和鼠同源基因的对应关系，下载自<http://www.ensembl.org/biomart/martview/>。

human.tissue.fpkm.rds and mouse.tissue.fpkm.rds, expression matrices of human and mouse organs.

mart_export.txt, correspondence between human and mouse homologous genes, downloaded from <http://www.ensembl.org/biomart/martview/>.
...
## 只有在并行计算代码块执行后才需要关闭集群 / Only close cluster if parallel computing code block was executed
if (exists("cl")) {
  stopCluster(cl)
}
## ==== do parallel end ====
...
filtered_results <- lmm.var.dcp[grep(highlight_pattern, 
                                    lmm.var.dcp$GenePairs, 
                                    ignore.case = TRUE), ]
filtered_results
