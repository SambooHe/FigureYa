...
The result is abysmal because different groups are not within the same range. Therefore, standardizing the log would be much better.
...
提取fdr最小的5个groups作图
Extract the smallest 5 groups of fdr for plotting
